...
public enum CITY_TYPE {
    METROPOLIS("FIRST-TIER_CITY", 5, 6000, 36, 50, 120, Material.DIAMOND_BLOCK),
    CITY("SECOND-TIER_CITY", 4, 4000, 30, 40, 80, Material.EMERALD_BLOCK),
    TOWN("THIRD-TIER_CITY", 3, 2000, 24, 30, 50, Material.GOLD_BLOCK),
    TOWNSHIP("FOURTH-TIER_CITY", 2, 1000, 18, 20, 30, Material.IRON_BLOCK),
    VILLAGE("FIFTH-TIER_CITY", 1, 500, 12, 10, 10, Material.STONE),
